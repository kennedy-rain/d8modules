...
class ImportForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $dir = DRUPAL_ROOT . '/' . \Drupal::service('extension.list.module')->getPathname('taxonomy_import') . '/src/data/';
  ...
  function getFilePath($filename) {
    ...
    if (substr($filename, 0, 1) != '/') {
      return DRUPAL_ROOT . '/' . \Drupal::service('extension.list.module')->getPathname('taxonomy_import') . '/src/data/' . $filename;
    } else {
      return $filename;
    }
  }
