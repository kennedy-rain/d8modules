...
class Templates extends PluginBase implements CKEditorPluginInterface, CKEditorPluginButtonsInterface {
   ...
   */
  function getFile() {
    return \Drupal::service('extension.list.module')->getPathname('ckeditor_templates') . '/js/plugins/templates/plugin.js';
  }
  /**
  ...
  function getButtons() {
    return array(
      'Templates' => array(
        'label' => t('Templates'),
        'image' => \Drupal::service('extension.list.module')->getPathname('ckeditor_templates') . '/js/plugins/templates/icons/templates.png',
      )
    );
  }
  /**
